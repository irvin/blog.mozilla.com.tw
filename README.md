...
沿用原 Mozilla Taiwan 網站授權。除另有註明外，本站內容皆採用 [創用 CC 姓名標示—相同方式分享條款 3.0 或更新版本](http://creativecommons.org/licenses/by-sa/3.0/) 授權大眾使用。

原站授權文字可見封存頁 footer：「除另有註明外，本站內容皆採用創用 CC 姓名標示—相同方式分享條款 3.0 或更新版本授權大眾使用。」
